...
return [
    ...
    'request_category_assignment' => 'طلب تعيين فئات جديدة',
    'request_category_subtitle' => 'اختر الفئات المناسبة لنشاطك التجاري',
    'tip' => 'نصيحة',
    'tip_categories' => 'اختر الفئات الرئيسية أولاً، ثم حدد الفئات الفرعية التي تريد العمل بها. الفئات المحددة حالياً تظهر بخلفية خضراء.',
    'select_one_or_more_main' => 'اختر فئة رئيسية أو أكثر',
    'select_subcategories_subtitle' => 'حدد الفئات الفرعية التي تريد العمل بها',
    'reason_for_request' => 'سبب الطلب',
    'reason_placeholder' => 'اشرح لنا لماذا تحتاج هذه الفئات لتطوير نشاطك التجاري...',
    'reason_hint' => 'تقديم سبب مقنع يساعد في تسريع الموافقة على طلبك',
    ...
    'plan' => 'الخطة',
    'plan_name' => 'اسم الخطة',
    'admin_credit' => 'إضافة رصيد من الإدارة',
    'admin_assigned' => 'مضاف من الإدارة',
    'order_payment_desc' => 'دفع الطلب رقم #:number',
    'subscription_payment_desc' => 'دفع اشتراك :name',
    'admin_credit_desc' => 'رصيد مضاف من المشرف',
    ...
    'insufficient_balance_top_up' => 'رصيد المحفظة غير كافٍ. يرجى شحن محفظتك قبل إنشاء الطلب.',
    'subscribe_to_create_orders' => 'اشترك الآن لإنشاء الطلبات',
    'subscription_required_orders' => 'يجب الاشتراك لإنشاء الطلبات',
    'view_on_china_store' => 'عرض على موقع الصين',
    'choice_free_shipping' => 'منتج Choice - شحن مجاني!',
    'choice_free_shipping_desc' => 'منتجات Choice تأتي بشحن مجاني وسريع',
    // Countries
    'kuwait' => 'الكويت',
    'qatar' => 'قطر',
    'bahrain' => 'البحرين',
    ...
    'order_auto_place_info' => 'سيتم إرسال هذا الطلب تلقائيًا إلى . إذا لم يحدث ذلك تلقائيًا، يمكنك استخدام الزر أدناه.',
