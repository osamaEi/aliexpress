...
<div class="col-12" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
    <!-- Page Header -->
    <div class="mb-4">
        <h4 class="mb-1">{{ __('messages.edit_currency') }}</h4>
        <p class="text-muted">{{ __('messages.edit_currency_description') }}</p>
    </div>
            ...
            <form action="{{ route('admin.currencies.update', $currency) }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="ri-save-line"></i> {{ __('messages.update') }}
                    </button>
