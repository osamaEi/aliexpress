...
<div class="col-12" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
    ...
    <div class="mb-4 d-flex justify-content-between align-items-center">
        <div>
            <h4 class="mb-1">{{ app()->getLocale() == 'ar' ? 'الكوبونات المنتهية' : 'Expired Coupons' }}</h4>
            <p class="text-muted">{{ app()->getLocale() == 'ar' ? 'جميع الكوبونات المنتهية الصلاحية' : 'All expired coupons' }}</p>
        </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.affiliate.coupons.expired') }}">
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3 d-flex align-items-end">
                        ...
                        <a href="{{ route('admin.affiliate.coupons.expired') }}" class="btn btn-outline-secondary">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="btn-group">
                ...
                <a href="{{ route('admin.affiliate.coupons.expired') }}" class="btn btn-sm btn-danger">
                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ app()->getLocale() == 'ar' ? 'انتهى في' : 'Expired On' }}</th>
                    ...
                    <tbody>
                        ...
                        <tr class="table-secondary">
                            <td>
                                <strong class="text-muted">{{ app()->getLocale() == 'ar' ? $coupon->title_ar : $coupon->title_en }}</strong>
                            </td>
                            <td>
                                @if($coupon->store)
                            ...
                            <td>
                                <code class="bg-light px-2 py-1 rounded text-muted">{{ $coupon->code }}</code>
                            </td>
                            <td>
                                @if($coupon->valid_for === 'website')
                                    <span class="badge bg-secondary">{{ app()->getLocale() == 'ar' ? 'الموقع' : 'Website' }}</span>
                                @elseif($coupon->valid_for === 'store')
                                    <span class="badge bg-secondary">{{ app()->getLocale() == 'ar' ? 'المتجر' : 'Store' }}</span>
                                @else
                                    <span class="badge bg-secondary">{{ app()->getLocale() == 'ar' ? 'الكل' : 'Both' }}</span>
                                @endif
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="text-success">{{ number_format($coupon->total_commission_earned, 2) }}</span>
                            </td>
                            <td>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="{{ route('admin.affiliate.coupons.edit', $coupon) }}">
                                                ...
                                                {{ app()->getLocale() == 'ar' ? 'تعديل وتجديد' : 'Edit & Renew' }}
                                            </a>
                                        </li>
                        ...
                        <tr>
                            <td colspan="10" class="text-center py-4">
                                <div class="text-muted">
                                    ...
                                    <p class="mt-2">{{ app()->getLocale() == 'ar' ? 'لا توجد كوبونات منتهية' : 'No expired coupons found' }}</p>
                                </div>
                            </td>
                        </tr>
                        @endforelse
