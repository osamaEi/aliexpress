...
<div class="col-12" dir="{{ app()->getLocale() == 'ar' ? 'rtl' : 'ltr' }}">
    <!-- Page Header -->
    <div class="mb-4">
        <h4 class="mb-1">{{ __('messages.add_new_plan') }}</h4>
        <p class="text-muted">{{ __('messages.create_new_subscription_plan') }}</p>
    </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('admin.subscriptions.store') }}">
                ...
                <div class="row mb-4">
                    ...
                    <!-- Color -->
                    <div class="col-md-6 mb-3">
                        <label for="color" class="form-label">{{ __('messages.plan_color') }} <span class="text-danger">*</span></label>
                        <input
                            type="color"
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            value="{{ old('max_orders_per_month') }}"
                            required
                        >
