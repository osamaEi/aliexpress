...
<head>
    ...
    <title>{{ app()->getLocale() == 'ar' ? 'تسجيل موزع جديد - الخطوة 1' : 'Distributor Registration - Step 1' }}</title>
    ...
    <div class="main-container">
        <div class="sidebar">
            <div class="logo-wrapper">
                ...
                <h3>{{ app()->getLocale() == 'ar' ? 'تسجيل موزع جديد' : 'Distributor Registration' }}</h3>
                <div class="distributor-badge">
                    <i class="ri-truck-line"></i>
                    <span>{{ app()->getLocale() == 'ar' ? 'حساب موزع' : 'Distributor Account' }}</span>
                </div>
            </div>
        ...
        <div class="content-area">
            <div class="content-header">
                ...
                <p>{{ app()->getLocale() == 'ar' ? 'ابدأ رحلتك كموزع معنا بتعبئة المعلومات الأساسية' : 'Start your journey as a distributor by filling basic information' }}</p>
            </div>
