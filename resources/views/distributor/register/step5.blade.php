...
<head>
    ...
    <title>{{ app()->getLocale() == 'ar' ? 'تسجيل متجر جديد - الخطوة 5' : 'Distributor Registration - Step 5' }}</title>
    ...
    <div class="main-container">
        <div class="sidebar">
            ...
            <div class="progress-sidebar">
                ...
                <div class="progress-step active">
                    ...
                    <div class="step-content">
                        <h4>{{ app()->getLocale() == 'ar' ? 'واتساب' : 'WhatsApp' }}</h4>
                        <p>{{ app()->getLocale() == 'ar' ? 'تأكيد رقم الهاتف' : 'Phone verification' }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="content-area">
            <div class="content-header">
                ...
                <h2>{{ app()->getLocale() == 'ar' ? 'تحقق من رقم واتساب' : 'Verify Your WhatsApp' }}</h2>
                <p>{{ app()->getLocale() == 'ar' ? 'أدخل الرمز المرسل عبر واتساب لإتمام التسجيل' : 'Enter the code sent via WhatsApp to complete registration' }}</p>
            </div>
            ...
            <form action="{{ route('distributor.register.verify-whatsapp-otp') }}" method="POST" id="otpForm">
                @csrf
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                <form action="{{ route('distributor.register.resend-whatsapp-otp') }}" method="POST" id="resendForm">
                    @csrf
