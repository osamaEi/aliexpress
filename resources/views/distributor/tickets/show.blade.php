        ...
        <div class="col-lg-10 mx-auto">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <a href="{{ route('distributor.tickets.index') }}" class="btn btn-secondary">
            ...
            @if($ticket->status !== 'closed')
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('distributor.tickets.reply', $ticket) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
