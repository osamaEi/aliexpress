        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('distributor.tickets.create') }}" class="btn btn-primary">
                ...
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach($tickets as $ticket)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('distributor.tickets.show', $ticket) }}"
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('distributor.tickets.create') }}" class="btn btn-primary mt-2">
