            ...
            @if($assignedProducts->count() > 0)
                    ...
                    <div class="col-md-3">
                        <div class="card text-white" style="background-color: #de2910;">
                            <div class="card-body">
                                ...
                                <small style="color: white;">{{ app()->getLocale() == 'ar' ? 'منتجات الصين' : 'China Products' }}</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card text-white" style="background-color: #00732f;">
                            <div class="card-body">
                                <h3 class="mb-0" style="color: white;">{{ $distributorProducts->count() }}</h3>
                                <small style="color: white;">{{ app()->getLocale() == 'ar' ? 'منتجات الموزعين' : 'Distributor Products' }}</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="aliexpress-tab" data-bs-toggle="tab" data-bs-target="#aliexpress" type="button" role="tab">
                            <span class="d-flex align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 32 32" class="me-2">
                                ...
                                {{ app()->getLocale() == 'ar' ? 'منتجات الصين (AliExpress)' : 'China Products (AliExpress)' }}
                                <span class="badge bg-danger ms-2">{{ $aliexpressProducts->count() }}</span>
                            </span>
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="distributor-tab" data-bs-toggle="tab" data-bs-target="#distributor" type="button" role="tab">
                            <span class="d-flex align-items-center">
                                <i class="ri-store-2-line me-2" style="font-size: 20px; color: #00732f;"></i>
                                {{ app()->getLocale() == 'ar' ? 'منتجات الموزعين (الإمارات/السعودية)' : 'Distributor Products (UAE/Saudi)' }}
                                <span class="badge bg-success ms-2">{{ $distributorProducts->count() }}</span>
                            </span>
                        </button>
                    </li>
                </ul>
                ...
                <div class="tab-content" id="productTabsContent">
                    ...
                    <div class="tab-pane fade" id="distributor" role="tabpanel">
                        ...
                        @else
                            <div class="text-center py-5">
                                <i class="ri-store-2-line" style="font-size: 4rem; color: #00732f; opacity: 0.5;"></i>
                                <h5 class="text-muted mt-3">{{ app()->getLocale() == 'ar' ? 'لا توجد منتجات من الموزعين' : 'No Distributor Products Yet' }}</h5>
                                <p class="text-muted">{{ app()->getLocale() == 'ar' ? 'ابحث عن منتجات من الإمارات أو السعودية وقم بتخصيصها' : 'Search for UAE or Saudi products and assign them' }}</p>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('products.search-distributor') }}?country_code=AE" class="btn btn-success">
                                        <span>🇦🇪</span> {{ app()->getLocale() == 'ar' ? 'منتجات الإمارات' : 'UAE Products' }}
                                    </a>
                                    <a href="{{ route('products.search-distributor') }}?country_code=SA" class="btn btn-success">
                                        <span>🇸🇦</span> {{ app()->getLocale() == 'ar' ? 'منتجات السعودية' : 'Saudi Products' }}
                                    </a>
                                </div>
                            </div>
                        @endif
