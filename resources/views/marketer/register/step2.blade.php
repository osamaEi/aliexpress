...
<head>
    ...
    <title>{{ app()->getLocale() == 'ar' ? 'تسجيل مسوّق - الخطوة 2' : 'Marketer Registration - Step 2' }}</title>
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="content-area">
            ...
            <form action="{{ route('marketer.register.verify-otp') }}" method="POST" id="otpForm">
                @csrf
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                <form action="{{ route('marketer.register.resend-otp') }}" method="POST" id="resendForm">
                    @csrf
