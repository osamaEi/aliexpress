...
<head>
    ...
    <title>{{ app()->getLocale() == 'ar' ? 'تسجيل مسوّق - الخطوة 3' : 'Marketer Registration - Step 3' }}</title>
    ...
    <div class="main-container">
        ...
        <div class="sidebar">
            <div class="logo-wrapper">
                ...
                <h3>{{ app()->getLocale() == 'ar' ? 'تسجيل المسوّق' : 'Marketer Registration' }}</h3>
            </div>
        ...
        <div class="content-area">
            ...
            <form action="{{ route('marketer.register.verify-whatsapp-otp') }}" method="POST" id="otpForm">
                @csrf
            ...
            <div style="text-align: center; margin-top: 30px;">
                ...
                <form action="{{ route('marketer.register.resend-whatsapp-otp') }}" method="POST" id="resendForm">
                    @csrf
