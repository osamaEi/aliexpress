...
class OrderProfitController extends Controller
{
    public function index(Request $request)
    {
        ...
        $totals = (clone $query)->selectRaw('
            ...
            SUM(admin_category_profit)  as total_admin_profit,
            SUM(seller_profit)          as total_seller_profit,
            SUM(COALESCE(aliexpress_profit,0) + COALESCE(admin_category_profit,0) + COALESCE(seller_profit,0)) as total_profit
        ')->first();
